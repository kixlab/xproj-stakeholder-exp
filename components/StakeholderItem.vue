  ...
  <!-- <v-layout row wrap justify-center> -->
    <v-card>
      ...
      <v-card-text class="item__question__box">
        <span><span class="blue--text">긍정적 {{tag.pos_count}}</span> vs <span class="red--text">{{tag.neg_count}} 부정적</span></span>
      </v-card-text>
      <v-card-actions> 
        <v-btn block @click="onTagClick">
          더 알아보기
        </v-btn>
      </v-card-actions>
    </v-card>
...
export default {
  ...
  computed: {
    pos: function () {
      return this.tag.pos_count / this.tag.total_count * 100
    },
    ref: function () {
  ...
  methods: {
    onTagClick: function () {
      this.$emit('tag-see-more', this.tag.tag)
    }
  }
}
</script>
