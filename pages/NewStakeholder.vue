...
<template>
  <v-layout row wrap justify-center>
    ...
    <v-flex xs12>
      ...
      <div>
        <p class="question">
          쓰신 설명 중, 이 정책과 관련있는 특징을 태그로 달아주세요.<br>
    ...
    <v-flex xs12 row wrap>
      <p class="question">
        여러분은 <strong>{{predictedEffect.stakeholder_detail}}</strong>(이)가 주인공인 소설을 쓰고 있습니다.
    ...
    <v-flex xs4>
      <div @click="predictedEffect.isBenefit === 0 ? predictedEffect.isBenefit = 1 : predictedEffect.isBenefit = 0">
      ...
      <!-- <v-btn 
        v-if="predictedEffect.isBenefit === 1" 
        color="primary"
        class="binarybtn"
      ...
      <v-btn 
        v-if="predictedEffect.isBenefit === 0" 
        color="error" 
        class="binarybtn" 
    ...
    <v-flex xs12>
      ...
      <p v-if="!allFilled" style="color:red;">모든 빈칸을 채운 후 추가해주세요.</p>
