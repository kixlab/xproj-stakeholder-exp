...
<template>
  <v-layout row wrap justify-center>
    ...
    <v-flex xs12 row wrap>
      ...
      <v-layout row wrap>
        <span v-if="!allFilled" style="color:red;"><br>모든 빈칸을 채워넣어야 다음으로 넘어갈 수 있습니다.<br></span>
        <v-flex xs6 style="align:left;">
          <v-btn dark color="secondary" @click="goBack">돌아가기</v-btn>
        </v-flex>
        <v-flex xs6 style="align:right;">
...
export default {
  ...
  computed: {
    ...
    allFilled: function () {
      console.log(this.selectedTags.length >= 2 && this.predictedEffect.description !== '' &&
